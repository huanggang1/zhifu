...
//	public $gatewayUrl = "https://openapi.alipay.com/gateway.do";
    ...
    public function getSignContent($params) {
        ...
        unset($k, $v);
//        file_put_contents("./log/signLog.txt", date("Y-m-d H:i:s") . "  " . json_encode($stringToBeSigned) . "\r\n", FILE_APPEND);
...
//            file_put_contents("./log/signLog.txt", date("Y-m-d H:i:s") . "  " . openssl_error_string() . "\r\n", FILE_APPEND);
        } else {
